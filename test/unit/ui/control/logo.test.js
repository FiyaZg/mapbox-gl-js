...
test('LogoControl appears in compact mode if container is less then 250 pixel wide', (t) => {
    ...
    Object.defineProperty(map.getCanvasContainer(), 'clientWidth', {value: 255, configurable: true});
    map.resize();
    t.equal(container.querySelectorAll('.mapboxgl-ctrl-logo:not(.mapboxgl-compact)').length, 1);

    Object.defineProperty(map.getCanvasContainer(), 'clientWidth', {value: 245, configurable: true});
    map.resize();
